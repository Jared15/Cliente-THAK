...
public class ConfiguracionMesa extends JFrame {
	...
	public ConfiguracionMesa(RMI rmi1,String nu1) throws RemoteException {
		this.rmi=rmi1;
		this.nu=nu1;
		...
		lblJugadores.setForeground(UIManager.getColor("Table.focusCellBackground"));
		lblJugadores.setBounds(53, 27, 132, 22);
		contentPane.add(lblJugadores);
		
		comboBox = new JComboBox();
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Azul", "Roja", "Verde"}));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				setVisible(false);
					...
					JOptionPane.showInternalMessageDialog(contentPane, "Numero de Juagdores Incorrectos", "Somos muy pocos.... o muchos?", JOptionPane.ERROR_MESSAGE);
			}
		});
		...
		button = new JButton("Actualizar Lista de Jugadores");
		...
		button.setBounds(46, 334, 377, 55);
		contentPane.add(button);
		
		comboBox_1 = new JComboBox();
		comboBox_1.setModel(new DefaultComboBoxModel(new String[] {"Estilo 1", "Estilo 2"}));
